...
const {verifyAccessToken, isAdmin , isStaff, isAdminOrStaff} = require('../middlewares/verifyToken');
...
router.route('/admin').get([verifyAccessToken, isAdminOrStaff], Order.getOrderAdmin);
